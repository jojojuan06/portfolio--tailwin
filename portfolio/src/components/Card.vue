<template>
  <div>
    <!-- Card -->
    <div style="max-width: 300px;max-height: 350px;height:350px" class="w-60 p-2 bg-white rounded-xl transform transition-all hover:-translate-y-2 duration-300 shadow-lg hover:shadow-2xl">
      <!-- Image -->
      ...
      <div class="p-2">
        ...
        <!-- Description -->
        <p class="overflow-auto h-16 text-sm text-gray-600">
